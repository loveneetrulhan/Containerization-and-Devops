...
```
![Docker Pull](images/p1-1-docker-pull-nginx.png.png)

### Step 2: Run the Container
```bash
docker run -d --name nginx-official -p 8080:80 nginx
```
![Docker Run](images/p1-2-run-container.png.png)

### Step 3: Verify
```bash
curl http://localhost:8080
```
![Curl Output](images/p1-4-browser-output.png.png)

### Key Observations
```bash
docker images nginx
```
![Docker Images](images/p1-3-docker-ps.png.png)
...
```
![Create Dockerfile](images/p2-1-dockerfile-ubuntu.png.png)

### Step 2: Build Image
```bash
docker build -t nginx-ubuntu .
```
![Build 1](images/p2-2-build-image.png.png)
![Build 2](images/p2-2-build-image.png.png)

### Step 3: Run Container
```bash
docker run -d --name nginx-ubuntu -p 8081:80 nginx-ubuntu
```
![Run Container](images/p2-3-run-container.png.png)

### Observations
```bash
docker images nginx-ubuntu
```
![Docker Images](images/p2-4-browser-output.png.png)
...
CMD ["nginx", "-g", "daemon off;"]
```
![Create Dockerfile](images/p3-1-dockerfile-alpine.png.png)

### Step 2: Build Image
```bash
docker build -t nginx-alpine .
```
![Build](images/p3-2-build-image.png.png)

### Step 3: Run Container
```bash
docker run -d --name nginx-alpine -p 8082:80 nginx-alpine
```
![Run Container](images/p3-3-run-container.png.png)

### Observations
```bash
docker images nginx-alpine
```
![Docker Images](images/p3-4-browser-output.png.png)
...
```
![nginx History](images/p4-2-history-official.png.png)
```bash
docker history nginx-ubuntu
```
![nginx-ubuntu History](images/p4-3-history-ubuntu.png.png)
```bash
docker history nginx-alpine
```
![nginx-alpine History](images/p4-4-history-alpine.png.png)
